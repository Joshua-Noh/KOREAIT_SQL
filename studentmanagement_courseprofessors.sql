...
CREATE TABLE `courseprofessors` (
  ...
  CONSTRAINT `courseprofessors_ibfk_1` FOREIGN KEY (`CourseID`) REFERENCES `courses` (`CourseID`),
  CONSTRAINT `courseprofessors_ibfk_2` FOREIGN KEY (`ProfessorID`) REFERENCES `professors` (`ProfessorID`)
...
INSERT INTO `courseprofessors` VALUES (1,1),(2,1),(6,1),(4,2),(5,2),(8,2),(3,3),(7,3),(9,4),(10,5);
