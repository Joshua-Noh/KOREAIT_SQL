...
CREATE TABLE `accommodations` (
  ...
  CONSTRAINT `accommodations_ibfk_1` FOREIGN KEY (`location_id`) REFERENCES `locations` (`location_id`)
...
INSERT INTO `accommodations` VALUES (1,'서울 호텔',1),(2,'부산 리조트',2),(3,'제주 펜션',3),(4,'강릉 모텔',4),(5,'대구 게스트하우스',5),(6,'북촌 민박',6),(7,'해운대 비치호텔',2),(8,'성산 게스트하우스',3),(9,'광안리 호텔',7),(10,'제주 힐링 하우스',3);
